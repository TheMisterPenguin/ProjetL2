...
ALLOBJ = $(addsuffix .o, $(addprefix $(ODIR), main init_close event monstres personnage affichage objet liste_objet listes map menus interface inventaire sorts test_affichage test_inventaire test_liste_objet test_listes test_map test_monstre test_personnage coffres))
OBJ = $(addsuffix .o, $(addprefix $(ODIR), main init_close event monstres personnage affichage objet liste_objet listes map menus interface inventaire sorts coffres))
OBJ_TEST_MONSTRES = $(addsuffix .o, $(addprefix $(ODIR), test_monstres monstres))
OBJ_TEST_MAP = $(addsuffix .o, $(addprefix $(ODIR), test_map map affichage init_close event listes personnage menus liste_objet objet inventaire interface monstres sorts coffres))
...
OBJ_TEST_AFFICHAGE = $(addsuffix .o, $(addprefix $(ODIR), test_affichage affichage listes init_close personnage personnage inventaire liste_objet objet map interface monstres sorts event menus coffres))
