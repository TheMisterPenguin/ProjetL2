...
void afficher_menu_pause(joueur_t *joueur[], char * f_src_objet, unsigned short int nb_joueurs){
    ...
    SDL_Rect boutton_sortie = {.w = floor(66 * multiplicateur_x), .h = floor(56 * multiplicateur_y)};

    SDL_Rect boutton_quitter = {.w = floor(1064 * multiplicateur_x), .h = floor(136 * multiplicateur_y)};
    SDL_Rect boutton_reprendre = {.w = floor(1064 * multiplicateur_x), .h = floor(136 * multiplicateur_y)};
    SDL_Rect boutton_sauvegarder = {.w = floor(1064 * multiplicateur_x), .h = floor(136 * multiplicateur_y)};
    SDL_Rect boutton_charger = {.w = floor(1064 * multiplicateur_x), .h = floor(136 * multiplicateur_y)};
...
void afficher_inventaire(joueur_t * joueur, SDL_KeyCode touche_inventaire)
{
    ...
    SDL_Rect slot0 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot1 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot2 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot3 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot4 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot5 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot6 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot7 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot8 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot9 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};

    SDL_Rect slot10 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot11 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot12 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot13 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot14 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
    SDL_Rect slot15 = {.w = floor(120 * multiplicateur_x), .h = floor(144 * multiplicateur_y)};
...
void afficher_menu_accueil(int * nb_joueur){
    ...
    SDL_Rect boutton_quitter = {.h = floor(136 * multiplicateur_y), 
    };
    SDL_Rect boutton_nouvelle_partie = {.w = floor(1064 * multiplicateur_x), .h = floor(136 * multiplicateur_y)};
    SDL_Rect boutton_solo = {.w = floor(1064 * multiplicateur_x), .h = floor(136 * multiplicateur_y)};
    SDL_Rect boutton_coop = {.w = floor(1064 * multiplicateur_x), .h = floor(136 * multiplicateur_y)};
...
static int draw_rect_epaisseur(const SDL_Rect * a_dessiner, SDL_Renderer *rendu, unsigned int epaisseur){
    ...
    SDL_Rect haut = {.x = a_dessiner->x, .y = a_dessiner ->y, .w = a_dessiner->w, .h = epaisseur};
    SDL_Rect bas = {.x = a_dessiner->x, .y = a_dessiner->y - epaisseur + a_dessiner->h, .w = a_dessiner->w, .h = epaisseur};
    SDL_Rect gauche = {.x = a_dessiner->x, .y = a_dessiner->y, .w = epaisseur, .h = a_dessiner->h};
    SDL_Rect droit = { .x = a_dessiner->x - epaisseur + a_dessiner->w, .y = a_dessiner->y, .w = epaisseur, .h = a_dessiner->h};
...
void afficher_inventaire_manette(joueur_t *joueur){
    ...
    /* Création des slots de l'inventaire */
    SDL_Rect slot0 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot1 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot2 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot3 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot4 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot5 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot6 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot7 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot8 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot9 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};

    SDL_Rect slot10 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot11 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot12 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot13 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot14 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
    SDL_Rect slot15 = {.w = floor(144 * multiplicateur_x), .h = floor(120 * multiplicateur_y)};
